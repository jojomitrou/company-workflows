...
| A2 setup guide v2 | DONE — see docs/CHANGELOG.md 2026-07-21 | 2026-07-21 | Core/Role-Add-on/Reference restructure; Gmail+Calendar+Jira wired via claude.ai Connectors; BigQuery `-e` fix; dead pm-skills ref fixed; duplicate numbering fixed; Verify step added; catalogue extracted to skills-catalogue.md |
